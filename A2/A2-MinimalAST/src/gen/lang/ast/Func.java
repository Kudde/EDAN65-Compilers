 ...
 * @astdecl Func : ASTNode ::= type:TypeDecl name:IdDecl;
 * @production Func : {@link ASTNode} ::= <span class="component">type:{@link TypeDecl}</span> <span class="component">name:{@link IdDecl}</span>;
...
public class Func extends ASTNode<ASTNode> implements Cloneable {
  ...
  public Func(TypeDecl p0, IdDecl p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /** @apilevel low-level 
