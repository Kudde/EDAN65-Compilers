...
/**
 * @ast node
 * @declaredat /Users/ludde/ht18/edan65/A2/A2-MinimalAST/src/jastadd/lang.ast:5
 * @astdecl Bloc : ASTNode ::= [Stmt];
 * @production Bloc : {@link ASTNode} ::= <span class="component">[{@link Stmt}]</span>;

 */
public class Bloc extends ASTNode<ASTNode> implements Cloneable {
  /**
   ...
   */
  public Bloc treeCopyNoTransform() {
    Bloc tree = (Bloc) copy();
    if (children != null) {
