...
public class WhileStmt extends Stmt implements Cloneable {
  /**
   * @aspect Interpreter
   * @declaredat C:\\Users\\Kevin Johansson\\Desktop\\HT2018\\EDAN65\\edan65\\A5\\A5-SimpliC\\src\\jastadd\\Interpreter.jrag:60
   */
...
protected boolean compatibleTypes_visited = false;
  ...
  public String Define_appendUniqueID(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getBlockNoTransform()) {
      // @declaredat C:\\Users\\Kevin Johansson\\Desktop\\HT2018\\EDAN65\\edan65\\A5\\A5-SimpliC\\src\\jastadd\\Interpreter.jrag:199
      return uniqueId();
    }
    else {
